...
for i in range(len(historico) - 5):
    ...
    14: [31, 9, 22, 18, 29, 7, 28, 12, 5, 24],
    15: [32, 0, 26, 3, 35, 12, 28, 7, 29, 18],
    16: [33, 1, 20, 14, 31, 9, 22, 18, 29, 7],
    17: [34, 6, 27, 13, 36, 11, 30, 8, 23, 10],
    18: [29, 7, 28, 12, 5, 24, 16, 33, 1, 20],
    19: [15, 32, 0, 26, 3, 35, 12, 28, 7, 29],
    20: [14, 31, 9, 22, 18, 29, 7, 28, 12, 5],
    21: [4, 19, 15, 32, 0, 26, 3, 35, 12, 28],
    22: [18, 29, 7, 28, 12, 5, 24, 16, 33, 1],
    23: [8, 30, 11, 5, 24, 16, 33, 1, 20, 14],
    24: [16, 33, 1, 20, 14, 31, 9, 22, 18, 29],
    25: [17, 34, 6, 27, 13, 36, 11, 30, 8, 23],
    26: [0, 32, 15, 19, 4, 21, 2, 25, 17, 34],
    27: [13, 36, 11, 30, 8, 23, 10, 5, 24, 16],
    28: [12, 5, 24, 16, 33, 1, 20, 14, 31, 9],
    29: [7, 28, 12, 5, 24, 16, 33, 1, 20, 14],
    30: [11, 5, 24, 16, 33, 1, 20, 14, 31, 9],
    31: [9, 22, 18, 29, 7, 28, 12, 5, 24, 16],
