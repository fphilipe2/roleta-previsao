...
for i in range(len(historico) - 5):
    ...
    for j in range(i+3, len(historico) - 2):
        ...
        if padrao_base == proximo_padrao:
            ...
            try:
                vizinhos_roleta = {
    0: [26, 3, 35, 12, 28, 32, 15, 19, 4, 21],
    1: [33, 16, 24, 5, 10, 20, 14, 31, 9, 22],
    2: [21, 4, 19, 15, 32, 25, 17, 34, 6, 27],
    3: [35, 12, 28, 7, 29, 26, 0, 32, 15, 19],
    4: [19, 15, 32, 0, 26, 21, 2, 25, 17, 34],
    5: [24, 16, 33, 1, 20, 10, 23, 8, 30, 11],
    6: [34, 17, 25, 2, 21, 27, 13, 36, 11, 30],
    7: [29, 18, 22, 9, 31, 28, 12, 35, 3, 26],
    8: [30, 11, 36, 13, 27, 23, 10, 5, 24, 16],
    9: [31, 14, 20, 1, 33, 22, 18, 29, 7, 28],
    10: [23, 8, 30, 11, 36, 5, 24, 16, 33, 1],
    11: [36, 13, 27, 6, 34, 30, 8, 23, 10, 5],
    12: [28, 7, 29, 18, 22, 35, 3, 26, 0, 32],
    13: [27, 6, 34, 17, 25, 36, 11, 30, 8, 23],
    14: [20, 1, 33, 16, 24, 31, 9, 22, 18, 29],
    15: [32, 0, 26, 3, 35, 19, 4, 21, 2, 25],
    16: [24, 5, 10, 23, 8, 33, 1, 20, 14, 31],
    17: [25, 2, 21, 4, 19, 34, 6, 27, 13, 36],
    18: [22, 9, 31, 14, 20, 29, 7, 28, 12, 35],
    19: [15, 32, 0, 26, 3, 4, 21, 2, 25, 17],
    20: [14, 31, 9, 22, 18, 1, 33, 16, 24, 5],
    21: [4, 19, 15, 32, 0, 2, 25, 17, 34, 6],
    22: [18, 29, 7, 28, 12, 9, 31, 14, 20, 1],
    23: [10, 5, 24, 16, 33, 8, 30, 11, 36, 13],
    24: [16, 33, 1, 20, 14, 5, 10, 23, 8, 30],
    25: [2, 21, 4, 19, 15, 17, 34, 6, 27, 13],
    26: [3, 35, 12, 28, 7, 0, 32, 15, 19, 4],
    27: [6, 34, 17, 25, 2, 13, 36, 11, 30, 8],
    28: [12, 35, 3, 26, 0, 7, 29, 18, 22, 9],
    29: [7, 28, 12, 35, 3, 18, 22, 9, 31, 14],
    30: [11, 36, 13, 27, 6, 8, 23, 10, 5, 24],
    31: [9, 22, 18, 29, 7, 14, 20, 1, 33, 16],
    32: [0, 26, 3, 35, 12, 15, 19, 4, 21, 2],
    33: [1, 20, 14, 31, 9, 16, 24, 5, 10, 23],
    34: [17, 25, 2, 21, 4, 6, 27, 13, 36, 11],
    35: [12, 28, 7, 29, 18, 3, 26, 0, 32, 15],
